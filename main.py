...
if __name__ == "__main__":
    ...
    parser.add_argument('-isaexts', help="ISA extentions (comma separated w/o spaces)", type=str, default="M,C")
    ...
    if args.exe and args.rp:
        os.system(f"{args.rp} --mode cli --src {args.o} -t asm --proc {args.proc} --isaexts {args.isaexts} --cycles")
